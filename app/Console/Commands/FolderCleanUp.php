...
class FolderCleanUp extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'clean:folder {--o : Verbose Output} {--dry : Runs in dry mode without deleting files.}';
     ...
     * @var string
     */
    protected $description = 'Cleans up useless files from  folder.';

    protected $patterns = 
            [
                /**List of Useless Folders*/
                'test',
                'tests',
                '.github',
                /**List of Useless Files*/
                '.git',
                '.gitignore',
                '*.md',
                '.*.yml',
